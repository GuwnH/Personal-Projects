...
#Extension in the main file at line 537
...
def main(argv):
    ...
    #Extension/Task1, this block of code below prints each individual result of the simulation into data.csv file and plots it into a graph using matplotlib 
